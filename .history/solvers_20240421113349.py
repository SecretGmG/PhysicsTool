...
def solve_eq(eq: Eq, target_symbol: Symbol, do_display: bool = False, tex: t.Optional[t.TextIO] = None) -> Expr:
    """
...
def derive_err(
    expr: Expr,
    values: t.Optional[t.List[Symbol]] = None,
    target_symbol: Symbol = Symbol('f'),
    err_prefix: str = 's',
    do_display: bool = False,
    tex: t.Optional[t.TextIO] = None
) -> Expr:
    """
...
def err_from_data(array: np.ndarray, axis=None) -> t.Tuple[np.ndarray, np.ndarray]:
    """
...
def avg_err(mean: np.ndarray, err: np.ndarray, axis=None) -> t.Tuple[np.ndarray, np.ndarray]:
    """
...
def calc_err(
    expr: Expr,
    values: t.Dict[Symbol, float | t.Tuple[float, float]],
    target_symbol: Symbol = Symbol('f'),
    err_prefix: str = 's',
    do_display: bool = False,
    tex: t.Optional[t.TextIO] = None
) -> t.Tuple[float, float] | t.Tuple[Expr, Expr]:
    """
