...
def solve_eq(eq: Eq, target_symbol: Symbol, do_display: bool = False, tex: Optional[TextIO] = None) -> Expr:
    """
    ...
    """
    log(f'solve the following expression for {target_symbol}', do_display, tex)
